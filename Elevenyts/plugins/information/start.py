...
async def start(_, message: types.Message):
    ...
    # ------------------- PREMIUM LOADING BAR -------------------
    if private:
        loading = await message.reply_text("⚡ Starting Arush X Music...")
    ...
    if private:
        try:
            ...
            msgs = [
                "🌟 <b>Welcome to Arush X Music</b> 🌟",
                "💖 <b>Welcome to the Ultimate Music Experience</b>",
                "🎵 <b>High Quality • Fast • Smooth Streaming</b>",
                "✨ Powered by <a href='https://t.me/Innocentpapaboltee'>Arush X Music</a> ✨"
            ]
